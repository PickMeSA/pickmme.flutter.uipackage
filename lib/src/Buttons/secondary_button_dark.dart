...
class SecondaryButtonDark extends StatelessWidget{
  ...
  factory SecondaryButtonDark.fullWidth({
  ...
  factory SecondaryButtonDark.small ({
    required VoidCallback? onPressed,
    required Widget child,
    VoidCallback? onLongPress,
    double width = 155,
  ...
  factory SecondaryButtonDark.icon({
    required VoidCallback? onPressed,
    required Icon child,
    VoidCallback? onLongPress,
    double width = 56,
  ...
  factory SecondaryButtonDark.smallIcon({
    required VoidCallback? onPressed,
    required Icon child,
    VoidCallback? onLongPress,
    double width = 40,
