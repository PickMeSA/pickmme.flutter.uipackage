...
class _AppTextFieldState extends State<AppTextField> {
  ...
  InputDecoration appInputDecoration(BuildContext context, {Icon? prefixIcon, String? hint, String? labelText, Color? bgColor, Color? borderColor, EdgeInsets? padding}) {
    return InputDecoration(
      ...
      enabledBorder: OutlineInputBorder(borderRadius: const BorderRadius.all(Radius.circular(8)), borderSide: BorderSide(color: borderColor??secondaryColor),),
      errorBorder: const OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(8)), borderSide: BorderSide(color: errorColor),),
      fillColor: bgColor??whiteColor,
      hintText: hint,
      labelText: labelText,
