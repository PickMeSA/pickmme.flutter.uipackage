...
class AppTimePickerFormField extends StatefulWidget {
  ...
  AppTimePickerFormField({
    ...
    this.acceptEmptyDate = false, this.onDateSelected,
  ...
  @override
  State<AppTimePickerFormField> createState() => _AppTimePickerFormFieldState();
}
...
class _AppTimePickerFormFieldState extends State<AppTimePickerFormField> {
  ...
  @override
  void didUpdateWidget(AppTimePickerFormField oldWidget) {
